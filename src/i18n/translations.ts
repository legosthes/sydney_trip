...
const translations = {
  ...
  "itinerary.statStops": { en: "stops", zh: "站點" },
  "itinerary.statActivities": { en: "activities", zh: "活動" },
  "itinerary.statMeals": { en: "meals", zh: "餐點" },
  ...
  "budget.subtitleShort": {
    en: "Live rates, category caps, expense log.",
    zh: "即時匯率、類別上限、開銷紀錄。",
  },
  "budget.accountDetails": { en: "Account details", zh: "帳戶明細" },
  "budget.left": { en: "Left", zh: "剩餘" },
  "budget.categories": { en: "Categories", zh: "類別" },
  ...
  "budget.account": { en: "Account", zh: "扣款帳戶" },
  "budget.accountCombined": { en: "Combined", zh: "共同帳戶" },
  ...
  "checklist.quickAddPlaceholder": { en: "Add item", zh: "新增項目" },
